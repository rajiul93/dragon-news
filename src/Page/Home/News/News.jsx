...
const News = ({news}) => {
    ...
    return (
        <div>
            <div className="rounded-md shadow-md  mb-8 dark:bg-gray-50 dark:text-gray-800">
	<div className="flex items-center justify-between p-3">
		<div className="flex items-center space-x-2">
			<img src={thumbnail_url} alt="" className="object-cover object-center w-8 h-8 rounded-full shadow-sm dark:bg-gray-500 dark:border-gray-300" />
	...
	<img src={thumbnail_url} alt="" className="object-cover object-center w-full h-72 dark:bg-gray-500" />
	<div className="p-3">
		...
		<p>
        {details.length > 400 ?details.slice(0,400) :details} <Link to={`/news-details/${_id}`} className="font-bold"> Read More ...</Link>
        </p>
		</div>
